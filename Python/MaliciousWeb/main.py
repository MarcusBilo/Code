...
if not exists('D:\Ablage\Dataset of Malicious and Benign Webpages\Good_Compact_Webpages_Classification_test_data.csv'):

    original_data_test = pd.read_csv('D:\Ablage\Dataset of Malicious and Benign Webpages\Webpages_Classification_test_data.csv')
    original_data_train = pd.read_csv('D:\Ablage\Dataset of Malicious and Benign Webpages\Webpages_Classification_train_data.csv')
    ...
    good_data_test.to_csv('D:\Ablage\Dataset of Malicious and Benign Webpages\Good_Compact_Webpages_Classification_test_data.csv', index=False)
    bad_data_test.to_csv('D:\Ablage\Dataset of Malicious and Benign Webpages\Bad_Compact_Webpages_Classification_test_data.csv', index=False)
    good_data_train.to_csv('D:\Ablage\Dataset of Malicious and Benign Webpages\Good_Compact_Webpages_Classification_train_data.csv', index=False)
    bad_data_train.to_csv('D:\Ablage\Dataset of Malicious and Benign Webpages\Bad_Compact_Webpages_Classification_train_data.csv', index=False)


og_good_train = pd.read_csv("D:\Ablage\Dataset of Malicious and Benign Webpages\Good_Compact_Webpages_Classification_train_data.csv")
og_good_test = pd.read_csv("D:\Ablage\Dataset of Malicious and Benign Webpages\Good_Compact_Webpages_Classification_test_data.csv")
bad_train = pd.read_csv("D:\Ablage\Dataset of Malicious and Benign Webpages\Bad_Compact_Webpages_Classification_train_data.csv")
bad_test = pd.read_csv("D:\Ablage\Dataset of Malicious and Benign Webpages\Bad_Compact_Webpages_Classification_test_data.csv")
...
if not exists('D:\Ablage\Dataset of Malicious and Benign Webpages\Good_Compact_Webpages_Classification_test_data_split_0.csv'):
