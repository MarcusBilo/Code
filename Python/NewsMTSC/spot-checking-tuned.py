...
def main():
    classifiers = [
        RandomForestClassifier(class_weight=None, criterion="entropy", max_depth=None, n_estimators=80),
        SVC(C=1.05, class_weight="balanced", coef0=0.0, degree=3, gamma="auto", kernel="poly"),
        SGDClassifier(class_weight="balanced", loss="squared_hinge", penalty="l2"),
        HistGradientBoostingClassifier(class_weight="balanced", max_depth=8, max_iter=80, min_samples_leaf=20),
        MLPClassifier(activation="logistic", hidden_layer_sizes=(75,), max_iter=200, solver="adam"),
